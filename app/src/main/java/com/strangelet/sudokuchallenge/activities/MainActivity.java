...
import com.strangelet.sudokuchallenge.utils.UserPoster;
...
public class MainActivity extends AppCompatActivity {
    //ToDo: add in app purchases and use country's local currency, clear database, replace the ad id, put app ads.txt,  and test if room code is working correct for rooms more than 1 day old
    // test your app
    ...
    private TextView beginnerTextView;
    private TextView easyTextView;
    private TextView mediumTextView;
    private TextView trickyTextView;
    private TextView fiendishTextView;
    private TextView diabolicalTextView;
...
//                    .setContentType(AudioAttributes.CONTENT_TYPE_SONIFICATION) //same here as above, press ctrl+b
        ...
        loadedSound = soundPool.load(MainActivity.this, R.raw.button_click, 1);//priority doesn't has any effect here, but it's recommended to pass a 1 here for future compatibility
        //oh! and don't forget to override onDestroy to release the soundPool object
        if(sfxEnabled()){
            buttonSound = loadedSound;
        }else{
            buttonSound = 0;
        }
        ...
        if(!getIntent().getBooleanExtra("noBoardDrop", false)) {
...
//        creditsView = findViewById(R.id.credits_text_view);
        ...
        howToPlayButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout closeBtn = dialog.findViewById(R.id.how_to_play_close_btn);
        ...
        storeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout closeBtn = dialog.findViewById(R.id.store_close_btn);
                closeBtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        dialog.dismiss();
        ...
        settingsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                settingsDialog.setContentView(R.layout.settings_main);
                ...
                LinearLayout settingsBackground = settingsDialog.findViewById(R.id.settings_background);
                LinearLayout helpBtn = settingsDialog.findViewById(R.id.get_help_btn);
                TextView termsAndConditionsBtn = settingsDialog.findViewById(R.id.terms_and_conditions_btn);
                TextView privacyPolicyBtn = settingsDialog.findViewById(R.id.privacy_policy_btn);
                LinearLayout soundPalette = settingsDialog.findViewById(R.id.sound_palette);

                ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) soundPalette.getLayoutParams();
                params.topMargin = 0;

                settingsBackground.setGravity(Gravity.CENTER);
                ...
                helpBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPool.play(buttonSound, 1, 1, 0, 0, 1);
                        Uri uri = Uri.parse("mailto:info.strangelet@gmail.com");
                ...
                PushDownAnim.setPushDownAnimTo(musicBtn, sfxBtn, privacyPolicyBtn, termsAndConditionsBtn, helpBtn).setScale(0.8f);
                ...
                musicBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(musicState && natureSoundsPlayer!=null && northernLightsPlayer!=null) {
                            stopMediaPlayer();
                            musicBtn.setImageResource(R.drawable.music_button_cancel);
                        }
                        else {
...
//                dialog.getWindow().setWindowAnimations(R.style.DialogScaleAnim_1);
        ...
        resumeGameButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("dailyChallenge", false);
                startActivity(intent);
...
//                                                            User currentUser = User.getCurrentUser();
    ...
    private void selectDifficulty(){
        ...
        difficultyLevelDialog.getWindow().setWindowAnimations(R.style.DifficultyDialogAnimation);
        difficultyLevelDialog.setCancelable(true);
        difficultyLevelDialog.show();

        beginnerTextView = (TextView) difficultyLevelDialog.findViewById(R.id.beginner_difficulty_view);
        beginnerTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                intent.putExtra("target", "GameActivity");
                intent.putExtra("gameType", "new game");
                intent.putExtra("difficulty", SudokuMaker.BEGINNER);
                startActivity(intent);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                finish();
            }
        ...
        trickyTextView = (TextView) difficultyLevelDialog.findViewById(R.id.tricky_difficulty_view);
        trickyTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                difficultyLevelDialog.dismiss();
                Intent intent = new Intent(MainActivity.this, BlankActivity.class);
                intent.putExtra("target", "GameActivity");
                intent.putExtra("gameType", "new game");
                intent.putExtra("difficulty", SudokuMaker.TRICKY);
                startActivity(intent);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                finish();
            }
        ...
        fiendishTextView = (TextView) difficultyLevelDialog.findViewById(R.id.fiendish_difficulty_view);
        fiendishTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                difficultyLevelDialog.dismiss();
                Intent intent = new Intent(MainActivity.this, BlankActivity.class);
                intent.putExtra("target", "GameActivity");
                intent.putExtra("gameType", "new game");
                intent.putExtra("difficulty", SudokuMaker.FIENDISH);
                startActivity(intent);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                finish();
            }
        ...
        diabolicalTextView = (TextView) difficultyLevelDialog.findViewById(R.id.diabolical_difficulty_view);
        diabolicalTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                difficultyLevelDialog.dismiss();
                Intent intent = new Intent(MainActivity.this, BlankActivity.class);
                intent.putExtra("target", "GameActivity");
                intent.putExtra("gameType", "new game");
                intent.putExtra("difficulty", SudokuMaker.DIABOLICAL);
                startActivity(intent);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                finish();
            }
...
//        TextView emailProfile = dialog.findViewById(R.id.email_profile);
        ...
        TextView beginnerSudokusPlayed = dialog.findViewById(R.id.beginner_games_played);
        TextView beginnerSudokusCompleted = dialog.findViewById(R.id.beginner_games_completed);
...
//        TextView mediumSudokuBestTime = dialog.findViewById(R.id.medium_best_time);
        ...
        TextView trickySudokusPlayed = dialog.findViewById(R.id.tricky_games_played);
        TextView trickySudokusCompleted = dialog.findViewById(R.id.tricky_games_completed);

        TextView fiendishSudokusPlayed = dialog.findViewById(R.id.fiendish_games_played);
        TextView fiendishSudokusCompleted = dialog.findViewById(R.id.fiendish_games_completed);

        TextView diabolicalSudokusPlayed = dialog.findViewById(R.id.diabolical_games_played);
        TextView diabolicalSudokusCompleted = dialog.findViewById(R.id.diabolical_games_completed);
...
//        emailProfile.setText(user.getEmail());
        ...
        beginnerSudokusPlayed.setText("\tGames played- " + user.getBeginnerGamesPlayed());
        beginnerSudokusCompleted.setText("\tGames completed- " + user.getBeginnerGamesCompleted());
...
//        mediumSudokuBestTime.setText("\t Best time taken- " + user.getMediumBestTimeTaken());
        ...
        fiendishSudokusPlayed.setText("\tGames played- " + user.getFiendishGamesPlayed());
        fiendishSudokusCompleted.setText("\tGames completed- " + user.getFiendishGamesCompleted());

        trickySudokusPlayed.setText("\tGames played- " + user.getTrickyGamesPlayed());
        trickySudokusCompleted.setText("\tGames completed- " + user.getTrickyGamesCompleted());

        diabolicalSudokusPlayed.setText("\tGames played- " + user.getDiabolicalGamesPlayed());
        diabolicalSudokusCompleted.setText("\tGames completed- " + user.getDiabolicalGamesCompleted());
...
//        difficultSudokuBestTime.setText("\t Best time taken- " + user.getDifficultBestTimeTaken());
    ...
    private void setRecurringAlarm(Context context) {
        ...
        // I don't know why, but alarm manager wasn't working at all
