...
public class SudokuMaker implements Serializable {
    ...
    public boolean finishedWithinTime = true;

    public static final int BEGINNER = 5;
    public static final int EASY = 10;
    public static final int MEDIUM = 15;
    public static final int TRICKY = 25;
    public static final int FIENDISH = 36;
    public static final int DIABOLICAL = 50;
    public static final int TIME_ATTACK = 20;
...
//    public SudokuMaker(){} //for custom view class SudokuBoard
    ...
    public OpponentSudoku getEmptyOpponentSudoku(){
        ArrayList<ArrayList<Integer>> opPartialBoard = new ArrayList<>();
        ArrayList<ArrayList<Integer>> opWorkingBoard = new ArrayList<>();
        for(int i = 0; i<9; i++){
            ArrayList<Integer> arrayList = new ArrayList<>();
    ...
    public void reset(){
        for(int i=0; i<partialBoard.length; i++)
            for(int j=0; j<partialBoard[i].length; j++)
                workingBoard[i][j]=partialBoard[i][j];
        selectedRow = -1;
        selectedColumn = -1;
